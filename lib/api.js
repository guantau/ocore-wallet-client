 ...
 * Fetch messages
 * @param {Object} opts
 * @param {String} opts.type [Required] - Indicate 'send' or 'receive' messages.
 * @param {String} opts.messageId [Optional] - Get messages before this message id.
